...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        #Show resulte
        self.status = QtWidgets.QListWidget(self.tab_2)
        self.status.setGeometry(QtCore.QRect(10, 0, 751, 541))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.status.setSortingEnabled(True)
